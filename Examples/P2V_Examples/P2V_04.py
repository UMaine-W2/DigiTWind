...
CH1_TOL       = 1.0                         # Surge displacement error tolerance (percentage of experimental std)
CH2_TOL       = 1.0                         # Pitch displacement error tolerance (percentage of experimental std)
