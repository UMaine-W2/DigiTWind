...
# Load yaml file 
parameter_filename = os.path.join(os.path.dirname(this_dir), 'Tune_Cases', 'IEA15MW_MultiOmega+TMD.yaml')
...
param_file = os.path.join(this_dir,path_params['FAST_directory'],'DISCON.IN')   # This must be named DISCON.IN to be seen by the compiled controller binary.
...
if False:
  ...
  plt.savefig(os.path.join(example_out_dir,'01_GainSched.png'))
