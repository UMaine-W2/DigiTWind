'''
----------- fPN1_OL --------------
pink noise 1 with Open Loop StC controller - Testing 2 FSA and 1 zeta
-------------------------------------
...
# Simulation time management & Wave Surface Elevation data
...
FSA = ['MF','PP']
KC_files = ['PN1_MF_fixed_zeta0d2.txt','PN1_PP_fixed_zeta0d2.txt']
for i in range(len(FSA)):
    ...
    TStart_Clean = fastin.fst_vt['Fst']['TStart']
    WaveMod_Clean = fastin.fst_vt['HydroDyn']['WaveMod']
    WaveTMax_Clean = fastin.fst_vt['HydroDyn']['WaveTMax']
    WvKinFile_Clean = fastin.fst_vt['HydroDyn']['WvKinFile']

    # Simulation Setup
    fastout.fst_vt['Fst']['TMax'] = TMax
    fastout.fst_vt['Fst']['TStart'] = TStart
    fastout.fst_vt['HydroDyn']['WaveMod'] = 5
    fastout.fst_vt['HydroDyn']['WaveTMax'] = TMax + 1
    ...
    fastout.fst_vt['Fst']['TStart'] = TStart_Clean
    fastout.fst_vt['HydroDyn']['WaveMod'] = WaveMod_Clean
    fastout.fst_vt['HydroDyn']['WaveTMax'] = WaveTMax_Clean
    fastout.fst_vt['HydroDyn']['WvKinFile'] = WvKinFile_Clean
    fastout.write_MainInput()
    fastout.write_HydroDyn()
